...
//        dataType: 'html',
//        success: function (data) {
//            $('#friend_' + publicId).replaceWith(data);
//        },
//        beforeSend: function () { beforeSend('result') },
//        complete: function () { complete('result') }
//    });
//}
//function AddToFriends(publicId) {
//    var id = publicId;
//    var data = { publicId: id };
//    var url = "/Friend/Confirm";
//    $.ajax({
//        url: url,
//        data: data,
//        type: "post",
//        dataType: 'html',
//        success: function (data) {
//            $('#follower_' + publicId).replaceWith(data);
//        },
//        beforeSend: function () { beforeSend('result') },
//        complete: function () { complete('result') }
//    });
...
//    });
//}
//function Unsubscribe(publicId) {
//    var id = publicId;
//    var data = { publicId: id };
//    var url = "/Friend/Unsubscribe";
//    $.ajax({
//        url: url,
//        data: data,
//        type: "post",
//        dataType: 'html',
//        success: function (data) {
//            $('#followed_' + publicId).replaceWith(data);
//        },
//        beforeSend: function () { beforeSend('result') },
//        complete: function () { complete('result') }
//    });
